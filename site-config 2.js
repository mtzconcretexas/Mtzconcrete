...
const CONFIG = {
  company: {
    ...
    seoDescription:
      "Residential and commercial concrete services across Austin, Central Texas, Dallas, Fort Worth and Houston."
  },
  ...
  hero: {
    eyebrow: {
      en: "CONCRETE WORK ACROSS TEXAS",
      es: "TRABAJO DE CONCRETO EN TEXAS"
    },
    ...
    lead: {
      en: "Driveways, parking lots, slabs, excavation and grading with clear communication from estimate to final cleanup.",
      es: "Entradas, estacionamientos, losas, excavación y nivelación con comunicación clara desde la cotización hasta la limpieza final."
    },
...
services: [
    ...
    },
    {
      ...
      text: {
        en: "Durable concrete parking areas built for reliable daily traffic.",
        es: "Áreas de estacionamiento de concreto duraderas para el tráfico diario."
      }
    },
    {
      icon: "layers",
    ...
    },
    {
      ...
      text: {
        en: "Site preparation, excavation and grading for proper drainage and a solid base.",
        es: "Preparación del terreno, excavación y nivelación para buen drenaje y una base sólida."
      }
    },
    {
      icon: "ruler",
  ...
  splitCards: {
    residential: {
      ...
      text: {
        en: "Driveways, walkways, slabs and concrete improvements planned around your property.",
        es: "Entradas, banquetas, losas y mejoras de concreto planeadas para tu propiedad."
      },
      button: {
    ...
    commercial: {
      ...
      text: {
        en: "Parking lots, slabs, excavation, grading and concrete support for contractors, property owners and growing businesses.",
        es: "Estacionamientos, losas, excavación, nivelación y trabajo de concreto para contratistas, propietarios y negocios en crecimiento."
      },
      button: {
  ...
  gallery: {
    ...
    title: {
      en: "REAL WORK SHOULD SPEAK FOR ITSELF",
      es: "EL TRABAJO REAL HABLA POR SÍ SOLO"
    },

    lead: {
      en: "This space is ready for MTZ before-and-after photos. We will add the real project gallery before the public launch.",
      es: "Este espacio está listo para fotos de antes y después de MTZ. Podemos agregar la galería real cuando quieras."
    },
...
networks: [
  ...
  serviceArea: {
    ...
    title: {
      en: "SERVING AUSTIN AND COMMUNITIES ACROSS TEXAS",
      es: "ATENDEMOS AUSTIN Y COMUNIDADES EN TODO TEXAS"
    },

    lead: {
      en: "Projects throughout Austin, Central Texas, San Antonio, Dallas, Fort Worth, Houston and surrounding communities.",
      es: "Proyectos en Austin, el centro de Texas, San Antonio, Dallas, Fort Worth, Houston y comunidades cercanas."
    },
...
mode: "demo",
    ...
    projectTypes: [
      ...
      { en: "Parking Lot", es: "Estacionamiento" },
      { en: "Concrete Slab", es: "Losa de concreto" },
      { en: "Excavation & Grading", es: "Excavación y nivelación" },
  ...
  footer: {
    tagline: {
      en: "Residential & Commercial Concrete · Texas",
      es: "Concreto Residencial y Comercial · Texas"
    }
  }
};
